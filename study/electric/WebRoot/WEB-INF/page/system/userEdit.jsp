...
<html>
 ...
 <body>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<!-- select中用value可以选择默认属性 -->
			<s:select name="sexID" id="sexID" list="#request.sexList" 
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select name="postID" id="postID" list="#request.postList" 
				listKey="ddlCode"	listValue="ddlName"		
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select name="jctID" id="jctID" list="#request.jctList" 
				listKey="ddlCode"	listValue="ddlName"		
				headerKey=""	headerValue="请选择"				
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select name="jctUnitID" id="jctUnitID" list="#request.jctUnitList" 
				listKey="ddlCode"	listValue="ddlName"		
				cssStyle="width:155px"  >
			</s:select>					
		</td>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:password	name="passwordconfirm" value="%{logonPwd}" showPassword="true" maxlength="25"  size="22"></s:password>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select name="isDuty" id="isDuty" list="#request.isDutyList" 
				listKey="ddlCode"	listValue="ddlName"		
				cssStyle="width:155px">
			</s:select>		
		</td>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:date name="onDutyDate" format="yyyy-MM-dd" var="onDutyDateTemp"/>
			<s:textfield name="onDutyDate" id="onDutyDate" value="%{onDutyDateTemp}" maxlength="50" size="20" onClick="WdatePicker()"></s:textfield>
		</td>
		<td align="center" bgColor="#f5fafe" class="ta_01">离职日期：<font color="#FF0000">*</font></td>
		<td class="ta_01" bgColor="#ffffff">
			<s:date name="offDutyDate" format="yyyy-MM-dd" var="offDutyDate"/>
			<s:textfield name="offDutyDate" id="offDutyDate" value="%{offDutyDate}" maxlength="50" size="20" onClick="WdatePicker()"></s:textfield>
		</td>
	</tr>
