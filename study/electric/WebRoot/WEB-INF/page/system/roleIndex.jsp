	...
	<HEAD>
		...
		<script language="javascript">
		 ...
		 function saveRole(){
		   ...
		   //jquery对象
		   //$("input[name='roleID']").val($("select[name='roleID']").val());   不加id的写法
		   $("#roleID").val($("select[name='roleID']").val());
...
/*        function selectRole(){
       ...
       function selectRole(){
       		if($("select[name='roleID']").val()=="0"){
       			...
       			//js中定义的函数，form1不动，from2动，传递的参数为form1表单中的值
											...
											<s:iterator value="#request.popedomList">
												<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
													<td class="ta_01"  align="left" width="18%" height="22" background="../images/tablehead.jpg" >
														<input type="checkbox"  name="selectoper" id="<s:property value="mid"/>_<s:property value="mid"/>" value="aa" onClick='goSelect(this.id)' >
													...
													<td class="ta_01"  align="left" width="82%" height="22">
														<s:if test="list!=null && list.size()>0">
															<s:iterator value="list">
																<div>
																	<input type="checkbox"  name="selectoper" id="<s:property value="pid"/>_<s:property value="mid"/>" value="ab" onClick='goSelect(this.id)' >
																	<s:property value="name"/>
																</div>
															</s:iterator>
														</s:if>
